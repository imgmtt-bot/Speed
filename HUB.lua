...
local Scripts = {
    ...
    [120766736586332] = function()  -- +1 Strength Per Click
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ikgmonxr/Speed/refs/heads/main/Fuerzaxclick.lua"))()
    end,

    [116223724643557] = function()  -- +1 Magic Evolution
        print("🎮 +1 Evolución Mágica detectado → Ejecutando...")
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ikgmonxr/Speed/refs/heads/main/Evolucion.lua"))()
    end,

    [86378115369061] = function()   -- +1 Backflip Obby Escape
        print("🎮 +1 Backflip Obby detectado → Ejecutando...")
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ikgmonxr/Speed/refs/heads/main/Speed.lua"))()
    end,

    [99457855080430] = function()   -- +1 Speed Barrel Escape (Nuevo)
        print("🎮 Escapa del Barril de Velocidad detectado → Ejecutando...")
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ikgmonxr/Speed/refs/heads/main/Escapabarril.lua"))()
    end,
}
